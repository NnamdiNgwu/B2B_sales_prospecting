...
// filepath: /Users/Nnamdi2/data_science_projects/B2B_sales_prospecting/prospect-ai-dashboard/src/components/Dashboard/Dashboard.tsx
    ...
    <div className="space-y-6">
      <Card>
        <div className="p-4 text-sm text-gray-700 dark:text-gray-300">
          Welcome to ProspectAI. Use the navigation to explore campaigns and analytics.
        </div>
      </Card>
      <CampaignPerformance />
    </div>
